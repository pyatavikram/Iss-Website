...
const services = [
  ...
  },
  {
    ...
    description:
      'Big data solutions, analytics, and machine learning implementations.',
    features: [
      'Data Pipelines',
      'ML Models',
      'Real-time Analytics',
  ...
  },
  {
    ...
    title: 'AI & Automation',
    description:
      'Artificial intelligence solutions to automate and optimize business processes.',
    features: [
      'Process Automation',
      'ChatBots',
      'AI Integration',
...
const ServiceCard = ({ service }) => {
  ...
  return (
    <Card
      className={`relative transition-all duration-300 hover:shadow-lg hover:-translate-y-1 h-full flex flex-col ${
